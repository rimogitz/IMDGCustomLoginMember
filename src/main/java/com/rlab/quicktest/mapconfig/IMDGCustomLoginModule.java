 ...
 *
 */
public class IMDGCustomLoginModule implements LoginModule  {
    ...
    public boolean login() throws LoginException {
        ...
        if (credentials instanceof IMDGLoginCredentials){
            loginOk = doLoginCheck((IMDGLoginCredentials) credentials);
        }

        return loginOk;
    }

    private boolean doLoginCheck(IMDGLoginCredentials credentials) {
